...
/**
 * TapTab posture flag. Controls whether `*ProjectionTapTabEditor` renders
 * its content as flowing prose (default) or as a stacked form. Set in
 * `*.ui.yaml` under the `taptab:` key.
 */
