...
export function MarkdownWidget({ field, value, onChange, readOnly, disabled, errors, compact }: WidgetProps) {
  ...
  return (
    <textarea
      ...
      disabled={disabled}
      rows={compact ? 2 : 4}
      className={`w-full border rounded outline-none resize-y font-mono focus:ring-1 focus:ring-blue-300 focus:border-blue-400 ${
