...
export function TextWidget({ field, value, onChange, readOnly, disabled, errors, compact }: WidgetProps) {
  ...
  return (
    <input
      type={field.widget === 'date' ? 'date' : field.widget === 'datetime' ? 'datetime-local' : 'text'}
      value={strVal}
