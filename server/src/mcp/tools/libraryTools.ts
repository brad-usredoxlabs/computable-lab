...
const LIBRARY_TYPES = ['material', 'labware', 'assay', 'reagent', 'buffer', 'cell_line', 'collection', 'context', 'operation_template'] as const;
...
const LIBRARY_SCHEMA_IDS: Record<string, string> = {
  ...
  operation_template: 'https://computable-lab.com/schema/computable-lab/operation-template.schema.yaml',
};
