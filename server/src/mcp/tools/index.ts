...
import { registerRunWorkspaceAiTools } from './runWorkspaceAiTools.js';
...
export function registerAllTools(server: McpServer, ctx: AppContext, registry?: ToolRegistry): void {
  ...
  registerVendorPdfTools(server, ctx, registry);
  registerVendorProtocolCandidateTools(server, ctx, registry);
  registerVendorProtocolEventGraphDraftTools(server, ctx, registry);
  registerVendorProtocolEventGraphPromotionTools(server, ctx, registry);
  registerLabwareSpecCandidateTools(server, ctx, registry);
  registerLabwareSpecPromotionTools(server, ctx, registry);
  registerOpentronsLabwareDefinitionTools(server, ctx, registry);
  registerExaTools(server, ctx, registry);
  registerRunWorkspaceAiTools(server, ctx, registry);
