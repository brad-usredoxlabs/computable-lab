...
import type { CompatibilityReportEntry } from '../../planning/transferPrograms.js';
...
class LocalAssistPlusEmitter implements AssistPlusEmitter {
  async emit(input: AssistEmitterInput): Promise<AssistEmitterOutput> {
    ...
    return {
      ...
      ...(compiled.compatibilityReport ? { compatibilityReport: compiled.compatibilityReport } : {}),
      emitter: 'local_ts',
    ...
    return {
      ...
      ...(typeof parsedJson?.notes === 'string'
        ...
        : fallbackCompiled.notes !== undefined
          ...
          : {}),
      ...(fallbackCompiled.compatibilityReport ? { compatibilityReport: fallbackCompiled.compatibilityReport } : {}),
      emitter: 'pyalab_http',
